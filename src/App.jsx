  ...
  return (
    <>
      <header className="site-header">
        <a className="wordmark" href="#top" aria-label="SNAPOD ホームページ">
          <span>SNAPOD</span>
    ...
    <section className="exploded-section" id="exploded" aria-labelledby="exploded-title">
      ...
      <figure className="exploded-showcase">
        <div className="exploded-video">
          <video
            ref={videoRef}
            src="/assets/video/snapod-exploded-seedance-a.mp4"
            poster="/assets/video/snapod-exploded-seedance-a-poster.webp"
            autoPlay
            muted
            loop
            playsInline
            ...
            aria-label="SNAPODの主要部材を分解して見せる爆発図動画"
          />
      ...
      <div className="spaces-grid">
        <figure className="space-card space-card--wide">
          <video
            ...
            playsInline
            preload="metadata"
            aria-label="ラウンジに設置したSNAPODの使用イメージ動画"
          />
...
export function App() {
  ...
  useEffect(() => {
    ...
    assetTasks.push(
      ...
      loadVideoMetadata("/assets/video/snapod-exploded-seedance-a.mp4"),
